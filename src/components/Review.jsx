          ...
          <div className='d-flex align-items-center'>
            ...
            <Box>
              <div className="rating stars">
                <Typography component="legend" className='typography'>Service</Typography>
                <Rating name="read-only" value={4} readOnly />
              </div>
              <div className="rating">
                <Typography component="legend" className='typography'>Tours</Typography>
                <Rating name="read-only" value={1} readOnly />
              </div>
              <div className="rating">
                <Typography component="legend" className='typography'>Flight</Typography>
                <Rating name="read-only" value={2} readOnly />
              </div>
              <div className="rating">
                <Typography component="legend" className='typography'>Bus</Typography>
                <Rating name="read-only" value={2} readOnly />
              </div>
            </Box>
            {/* end rating */}
